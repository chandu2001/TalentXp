      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto font-body">
            We deliver a wide range of IT services that are critical for modern enterprises to succeed in the digital landscape.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service) => (
            <div
              key={service.title}
              className="bg-card rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 p-8 border hover:border-primary/50 group transform hover:-translate-y-2 h-full flex flex-col"
            >
              ...
              <p className="text-muted-foreground leading-relaxed font-body flex-grow">
                {service.description}
              </p>
            </div>
          ))}
