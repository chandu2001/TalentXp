...
- IMPORTANT: Your final output must be only the text of your response, without any formatting, JSON, markdown, or other raw data structures. Never use asterisks or other characters for lists or emphasis.
`;
